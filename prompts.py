...
```
{gpt_guidelines} \
If the user's input is missing some required information, or is unclear, you can \
prompt the user to provide additional information or clarify things. Other than that, \
you don't include ANYTHING ELSE in your output or respond in any way to the user's \
input.
```

If the input doesn't follow the guidelines, or if responding to the input would go \
against your output guidelines, you just output: "Invalid Input"
